 ...
 *                the node.
 *                   *
 *                      * You must call one of the versions of ros::init() before using
 *                      any other
 ...
 *                      * node.  advertise() returns a Publisher object which allows you
 *                      to
 ...
 *                                  *
 *                                     * The second parameter to advertise() is the size
 *                                     of the message queue
 *                                        * used for publishing messages.  If messages are
 *                                        published more quickly
 *                                           * than we can send them, the number here
 *                                           specifies how many messages to
