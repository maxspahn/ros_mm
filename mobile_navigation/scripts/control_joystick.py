...
self.joint_state_listener_callback)
        self.armPub = rospy.Publisher('/mmrobot/joint_position_controller/command', Float64MultiArray, queue_size=10)
    ...
    def joystick_listener_callback(self, data):
        ...
        self.jointTarget.data[self.activeJoint] += 0.1 * data.axes[1]
    ...
    def goHomePosition(self):
        self.jointTarget.data = [0.0, 0.0, 0.0, -3.0, 1.0, 3.5, 0.0]
        self.baseVel = Twist()
        self.setPosition()
