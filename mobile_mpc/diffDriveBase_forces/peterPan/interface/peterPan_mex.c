...
extern void peterPan_casadi2forces(peterPan_float *x, peterPan_float *y, peterPan_float *l, peterPan_float *p, peterPan_float *f, peterPan_float *nabla_f, peterPan_float *c, peterPan_float *nabla_c, peterPan_float *h, peterPan_float *nabla_h, peterPan_float *hess, solver_int32_default stage, solver_int32_default iteration);
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help peterPan_mex' for details.");
    }    
	if (nlhs > 3) 
	{
    ...
    if( mxGetM(par) != 50 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [50 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,50);
